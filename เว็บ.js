...
<head>
    ...
    <script>
        ...
        function updateValues() {
            fetch('http://192.168.1.2/')  // เปลี่ยน URL ตาม IP ของ ESP8266
                .then(response => {
                    if (!response.ok) {
...
<body>
    <div class="container">
        <div class="university-logo">
            <img src="https://www.pbru.ac.th/pbru/wp-content/uploads/2019/12/PBRU-Logo.png" alt="ตรามหาวิทยาลัยราชภัฏเพชรบุรี" width="200">
        </div>
        <div class="system-name">
            มหาวิทยาลัยราชภาคเพชรบุรี
        </div>
        <div class="system-name">
